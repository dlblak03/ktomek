...
<svelte:head>
	<title>Ktomek | Testimonials</title>

	<meta
		name="description"
		content="Experience excellence and innovation through our client's voices. 
		Discover how Ktomek's tailored IT and consulting solutions drive success in diverse industries."
	/>
</svelte:head>
...
>
		...
		<div class="tablet-above">
			<Row gap="20px">
				<!-- <Button color={$dark ? 'var(--darktext)' : 'var(--primary)'}
					><a href="/auth?type=life" class="link-a">Life</a></Button
				> -->
				<Button color={$dark ? 'var(--darktext)' : 'var(--primary)'}
			...
			<ul class="menu" style="background: {$dark ? 'rgb(20,20,20)' : 'rgb(250,250,250)'}">
				...
				<!-- <li>
					<a
						href="/auth?type=life"
						class="link-a"
						style="color: {$dark ? 'var(--darktext)' : 'var(--primary)'} !important">Ktomek Life</a
					>
				</li> -->
				<li>
					<a
	...
	<Column grow="1" align="center" gap="20px" width="100%">
		<Column maxwidth="1400px" minwidth="300px" gap="50px" marginbottom="0" grow="1" width="100%">
			<Column align="center" margintop="50px" gap="20px" width="100%">
				...
				<Header align="center" color={$dark ? 'var(--darktext)' : '#222'} weight="400"
					>Discover a piece of the Ktomek Life experience through client testimonials</Header
				>
			</Column>
			<Row grow="1" width="100%" gap="50px" wrap="wrap" rowgap="50px">
				<Card dark={$dark} width="400px" maxwidth="400px">
					{#if $dark}
						<Row
							width="400px"
							cursor="pointer"
						...
						>
							<Image
								width="100%"
								src=" dbd_testimonial_preview_dark.png"
							/>
						</Row>
					{:else}
						<Row
						...
						>
							<Image
								width="100%"
								src=" dbd_testimonial_preview.png"
							/>
						</Row>
					{/if}

					<div
						style="transition: all 300ms; max-height: {toggleDBD
							? '750px'
							: '0'}; display: flex; flex-direction: column;"
					>
						<Column padding="20px 20px 20px 20px">
							<Header color={$dark ? 'var(--darktext)' : 'var(--primary)'}
								>Dream Boat Docks LLC</Header
							>
							<Body color={$dark ? 'var(--darktext)' : '#222'}
								>Dream Boat Docks is a premier provider of custom, high-quality dock and remodeling
								solutions, committed to delivering exceptional craftsmanship tailored to meet
								diverse construction needs across Southern Texas.</Body
							>
							<ButtonPrimary>
								<a
									href="https://dreamboatdocks.com/"
									target="_blank"
									style="color: var(--darktext);">Visit Dream Boat Docks</a
								>
							</ButtonPrimary>
							<Body color={$dark ? 'var(--darktext)' : '#222'}
								>Tags: #Houston, #Texas, #Construction, #Boat Docks</Body
							>
						</Column>
					</div>
				</Card>
				...
				<Card dark={$dark} width="400px" maxwidth="400px">
					{#if $dark}
						...
						>
							<Image
								width="100%"
								src=" tsc_testimonial_preview_dark.png"
							/>
						</Row>
					{:else}
						<Row
						...
						>
							<Image
								width="100%"
								src=" tsc_testimonial_preview.png"
							/>
						</Row>
					{/if}
					<div
						style="transition: all 300ms; max-height: {toggleTSC
							? '750px'
							: '0'}; display: flex; flex-direction: column;"
					>
						<Column padding="20px 20px 20px 20px">
							<Header color={$dark ? 'var(--darktext)' : 'var(--primary)'}
								>Taylored Shoreline Construction LLC</Header
							>
							<Body color={$dark ? 'var(--darktext)' : '#222'}
								>Taylored Shoreline Construction is a veteran-owned construction business
								specializing in high-quality bulkhead, pier, and boathouse construction, delivering
								exceptional work with unwavering commitment to customer satisfaction and attention
								to detail.</Body
							>
							<ButtonPrimary>
								<a
									href="https://taylored-shoreline-construction.com/"
									target="_blank"
									style="color: var(--darktext)">Visit Taylored Shoreline Construction</a
								>
							</ButtonPrimary>

							<Body color={$dark ? 'var(--darktext)' : '#222'}
								>Tags: #Houston, #Texas, #Shoreline Construction, #Veteran-Owned</Body
							>
						</Column>
					</div>
				</Card>
